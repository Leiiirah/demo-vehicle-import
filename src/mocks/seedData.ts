...
export const seedVehicles: Vehicle[] = [
  ...
  { id: 'veh-1',  brand: 'Toyota',   model: 'Land Cruiser', year: 2024, vin: 'JTMWF4DV4P5012345', clientId: 'cli-1', supplierId: 'sup-1', conteneurId: 'con-1', passeportId: 'pas-1',  saleId: 'sal-5', status: 'sold',       purchasePrice: 45000, transportCost: 2100, theoreticalRate: 134, passeportCost: 50000, localFees: 320000, totalCost: 6681400,  sellingPrice: 7200000,  photoUrl: photo('1503376780353-7e6692767b70'), color: 'Blanc',  transmission: 'automatic', paymentStatus: 'solde',     amountPaid: 7200000,  orderDate: '2026-01-08', arrivalDate: '2026-02-20', soldDate: '2026-04-15' },
  { id: 'veh-2',  brand: 'Mercedes', model: 'GLE 450',      year: 2024, vin: 'W1N2534861A123456', clientId: 'cli-2', supplierId: 'sup-1', conteneurId: 'con-1', passeportId: 'pas-2',  saleId: 'sal-4', status: 'sold',       purchasePrice: 62000, transportCost: 2100, theoreticalRate: 134, passeportCost: 50000, localFees: 410000, totalCost: 9049400,  sellingPrice: 9800000,  photoUrl: photo('1618843479313-40f8afb4b4d8'), color: 'Noir',   transmission: 'automatic', paymentStatus: 'versement', amountPaid: 4500000,  orderDate: '2026-01-08', arrivalDate: '2026-02-20', soldDate: '2026-03-22' },
  { id: 'veh-3',  brand: 'BMW',      model: 'X5 M50i',      year: 2024, vin: '5UXCR6C51N9A12345', clientId: 'cli-3', supplierId: 'sup-1', conteneurId: 'con-2', passeportId: 'pas-3',  status: 'in_transit', purchasePrice: 58000, transportCost: 1900, theoreticalRate: 134, passeportCost: 50000, localFees: 380000, totalCost: 8456600,  sellingPrice: 9200000,  photoUrl: photo('1555215695-3004980ad54e'), color: 'Bleu',   transmission: 'automatic', paymentStatus: 'versement', amountPaid: 3000000,  orderDate: '2026-02-01' },
  { id: 'veh-4',  brand: 'Audi',     model: 'Q8',           year: 2024, vin: 'WAUZZZF18PN012345', clientId: 'cli-4', supplierId: 'sup-2', conteneurId: 'con-3', passeportId: 'pas-4',  status: 'arrived',    purchasePrice: 55000, transportCost: 2250, theoreticalRate: 134, passeportCost: 50000, localFees: 390000, totalCost: 8111500,  sellingPrice: 8750000,  photoUrl: photo('1606664515524-ed2f786a0bd6'), color: 'Gris',   transmission: 'automatic', paymentStatus: 'solde',     amountPaid: 8750000,  orderDate: '2026-01-15', arrivalDate: '2026-03-01' },
  { id: 'veh-5',  brand: 'Porsche',  model: 'Cayenne',      year: 2024, vin: 'WP1AB2A53PLB12345', clientId: 'cli-5', supplierId: 'sup-2', conteneurId: 'con-3', passeportId: 'pas-5',  saleId: 'sal-3', status: 'sold',       purchasePrice: 78000, transportCost: 2250, theoreticalRate: 134, passeportCost: 50000, localFees: 520000, totalCost: 11323500, sellingPrice: 12500000, photoUrl: photo('1503376780353-7e6692767b70'), color: 'Rouge',  transmission: 'automatic', paymentStatus: 'solde',     amountPaid: 12500000, orderDate: '2026-01-15', arrivalDate: '2026-03-01', soldDate: '2026-03-05' },
  { id: 'veh-6',  brand: 'Lexus',    model: 'LX 600',       year: 2024, vin: 'JTJHY00W104012345', clientId: undefined, supplierId: 'sup-2', conteneurId: 'con-4', passeportId: undefined, status: 'in_transit', purchasePrice: 88000, transportCost: 3700, theoreticalRate: 134, passeportCost: 0,     localFees: 540000, totalCost: 12827800, sellingPrice: undefined,    photoUrl: photo('1552519507-da3b142c6e3d'), color: 'Blanc',  transmission: 'automatic', paymentStatus: null,        amountPaid: 0,        orderDate: '2026-02-12' },
  { id: 'veh-7',  brand: 'Range Rover', model: 'Vogue',     year: 2024, vin: 'SALGS2RU1NA012345', clientId: 'cli-6', supplierId: 'sup-3', conteneurId: 'con-5', passeportId: 'pas-6',  status: 'in_transit', purchasePrice: 95000, transportCost: 1200, theoreticalRate: 134, passeportCost: 50000, localFees: 580000, totalCost: 13520800, sellingPrice: 14200000, photoUrl: photo('1606664515524-ed2f786a0bd6'), color: 'Noir',   transmission: 'automatic', paymentStatus: 'versement', amountPaid: 5000000,  orderDate: '2026-02-15' },
  { id: 'veh-8',  brand: 'Toyota',   model: 'Hilux',        year: 2024, vin: 'MR0FZ22G900012345', clientId: undefined, supplierId: 'sup-3', conteneurId: 'con-5', passeportId: undefined, status: 'in_transit', purchasePrice: 32000, transportCost: 1200, theoreticalRate: 134, passeportCost: 0,     localFees: 240000, totalCost: 4688800,  sellingPrice: undefined,    photoUrl: photo('1568605114967-8130f3a36994'), color: 'Beige',  transmission: 'manual',    paymentStatus: null,        amountPaid: 0,        orderDate: '2026-02-15' },
  ...
  { id: 'veh-16', brand: 'Suzuki',   model: 'Vitara',       year: 2024, vin: 'TSMLY21S00G012345', clientId: undefined, supplierId: 'sup-3', conteneurId: 'con-5', passeportId: undefined, status: 'vendu_bare' as Vehicle['status'], purchasePrice: 22000, transportCost: 1200, theoreticalRate: 134, passeportCost: 0, localFees: 180000, totalCost: 3290800, sellingPrice: 3600000, photoUrl: photo('1503376780353-7e6692767b70'), color: 'Vert', transmission: 'manual', paymentStatus: 'solde', amountPaid: 3600000, orderDate: '2026-02-15', soldDate: '2026-04-18' },
];
